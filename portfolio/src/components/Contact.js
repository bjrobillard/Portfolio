...
// add onclick function to button or just leave phone and email for them to use at their discretion
    ...
    <section id="contact" className="relative">
      <div className="container px-5 py-10 mx-auto text-center lg:px-40">
        <div className="flex flex-col w-full mb-20">
          <FaPhone className="mx-auto inline-block w-10 mb-4" />
          <h1 className="sm:text-4xl text-3xl font-medium title-font mb-4 text-center text-white">
            Contact Information
          </h1>  
        </div>
        ...
        {/* <form
          ...
          <p className="leading-relaxed mb-5">
            Please leave your name, email, and a any questions you may have regarding my resume or past work expierence!
          </p>
